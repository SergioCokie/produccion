$(document).ready(function () {
	...
	if (rol_id == 1) {
		$("#tabla_flexografia tbody tr").dblclick(function () {
	...
	$(".cambiar_estado").click(function (e) {
		...
		$(this).val() == "Revisado" ? estado = "fue enviado" : $(this).val() == "Cerrado" ? estado = "fue cerrado" : estado = "fue transferido";
	...
	$(".tiempo").change(function (e) {//SE CALCULA LA DIFERENCIA DE TIEMPO 3
