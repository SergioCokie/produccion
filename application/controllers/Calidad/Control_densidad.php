...
class control_densidad extends Padre
{
    /**
    ...
    public function index()
    {
        ...
        $data["operador"] = $this->General_model->getTable("operadores", array("tipo"=>"Operador"));
        $data["auxiliar"] = $this->General_model->getTable("operadores", array("tipo"=>"Auxiliar"));
        $data["supervisor"] = $this->General_model->getTable("operadores", array("tipo"=>"Supervisor"));
        $data["calidad"] = $this->General_model->getTable("operadores", array("tipo"=>"Calidad"));
